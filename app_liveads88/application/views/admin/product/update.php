						...
						<?php
						  ...
						  <div id="wizard">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
								  ...
								  <div class="col-md-6 col-sm-6 col-xs-12">
									...
									<img id="output" height="100" src="<?php echo base_url()."uploads/product/".$product->pro_image_name; ?>" />
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" class="form-control col-md-7 col-xs-12"  name="paid_ads_end_date" id="paid_ads_end_date"  value="<?php echo $product->paid_ads_end_date; ?>">
