...
<div class="right_col" role="main">
 ...
 -->
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" placeholder="Start Date" id="cu_start_date" class="form-control has-feedback-left" name="cu_start_date" value="<?php echo set_value('cu_start_date'); ?>">
                      <span aria-hidden="true" class="fa fa-file-word-o form-control-feedback left"></span>
					  <?php echo form_error('cu_start_date');?> 
                    </div>
                    
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" placeholder="End Date" id="cu_end_date" class="form-control has-feedback-left" name="cu_end_date" value="<?php echo set_value('cu_end_date'); ?>">
                      <span aria-hidden="true" class="fa fa-file-word-o form-control-feedback left"></span>
					 ...
					 <div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback">
						...
						<input type="radio" value="1" name="cu_status" id="cu_status1" checked="checked"> Active
						</label>
						
						<label for="cu_status0">
						<input type="radio" value="0" name="cu_status" id="cu_status0"> Inactive
						</label>
                     ...
                     <div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback">
						...
						<label for="cu_brand1">
						<input type="radio" value="1" name="cu_show_brand" id="cu_brand1"  checked="checked"> Show
						</label>
						
						<label for="cu_brand0">
						<input type="radio" value="0" name="cu_show_brand" id="cu_brand0" > Hide
						</label>
