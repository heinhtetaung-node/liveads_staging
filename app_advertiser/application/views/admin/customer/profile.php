                ...
                <div class="x_content">
                  <br>
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback"> <img id="output_logo" height="100" src="<?php echo base_url()."uploads/brand/".$customer->cu_logo_name; ?>"/> </div>
					</div>
					
					<div class="form-group">
						<div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback"> Image </div>
						<div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback"> <img id="output" height="100" src="<?php echo base_url()."uploads/customer/".$customer->cu_image_name; ?>"/> </div>
					</div>
						...
						<div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback"> 
							...
							if($shopimages){
								foreach($shopimages as $image){
									echo '<img id="output" height="100" src="' . base_url() . $image['sp_name'].'" /> <br /> <br />';
								}
							} 
							?> 
						</div>
