              ...
              <div class="x_panel">
                <div class="x_content">
				 <?php echo $this->session->flashdata('msg'); ?>
                  <br>
                  <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>splash/add" id="event_form" enctype="multipart/form-data">
					
    				<div class="form-group">
                      <label for="title" class="control-label col-md-3 col-sm-3 col-xs-12">Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control col-md-7 col-xs-12"  id="name" name="sp_name" value="<?php echo set_value('sp_name'); ?>">                     
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="spimg_linkto" id="spimg_linkto" class="form-control col-md-7 col-xs-12">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control col-md-7 col-xs-12"  id="sp_website" name="sp_website" value="<?php echo set_value('sp_website'); ?>">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control col-md-7 col-xs-12"  id="email" name="sp_email" value="<?php echo set_value('sp_email'); ?>">
...
<script>
  $( function() {
	...
	$("#data_upload").click(function(){
		...
		if($("#data_sp_image").val() == ""){
			dialog_message = "Image required.";
			has_error =  true;
		}else if($('#spimg_linkto').val() == "website"){
			if($('#sp_website').val() == ""){
				has_error = true;
		...
		}else if($('#spimg_linkto').val() == "customer"){
			if($("#customer_id").val() == ""){
				has_error = true;
