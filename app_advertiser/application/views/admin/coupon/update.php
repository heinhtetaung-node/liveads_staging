                 ...
                 <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>coupon/update/<?php echo $this->uri->segment(3);?>" id="coupon_form" enctype="multipart/form-data">
					...
					<div class="date-range-wrapper">
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" disabled class="form-control col-md-7 col-xs-12"  name="cp_valid_to" id="valid_date_to"  value="<?php echo ($coupon!== false ? ($coupon->cp_valid_to!="0000-00-00" ? $coupon->cp_valid_to : '') : set_value('cp_valid_to')); ?>">
					...
					<div class="limited-quantity-wrapper">
					  ...
					  <div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" class="form-control col-md-7 col-xs-12"  name="paid_ads_start_date" disabled id="paid_ads_start_date"  value="<?php echo ($coupon!== false ? ($coupon->paid_ads_start_date!="0000-00-00" ? $coupon->paid_ads_start_date : '') : set_value('paid_ads_start_date')); ?>">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" disabled class="form-control col-md-7 col-xs-12"  name="paid_ads_end_date" id="paid_ads_end_date"  value="<?php echo ($coupon!== false ? ($coupon->paid_ads_end_date!="0000-00-00" ? $coupon->paid_ads_end_date : '') : set_value('paid_ads_end_date')); ?>">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						...
						if(!empty($cp_image_return) && $cp_image_return!=""){
							...
							echo '<div id="resize_image_cp_image" ><img src="'.$base.'uploads/coupon/'.$coupon->cp_img_name .'" height="100" /></div>';
						}
						?>
						</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6 col-sm-6 col-xs-12">
						<div data-toggle="buttons" class="btn-group" id="livestatus">
						  ...
						  <?php }else if($coupon->livestatus==1){ ?>
					...
					<a href="<?php echo base_url(); ?>Ads/index/Coupons" class="btn btn-primary">Back to List</a>
					<?php if($coupon->livestatus!=2){ ?>
