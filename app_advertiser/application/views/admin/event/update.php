                ...
                <div class="x_content">
                 ...
                 <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>event/update/<?php echo $this->uri->segment(3);?>" id="event_form" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
						...
						if(!empty($ev_image_return) && $ev_image_return!=""){
							...
							echo '<div id="resize_image_ev_image" ><img src="'. $base."uploads/event/".$event->ev_img_name .'" height="100" /></div>';
						}
						?>
						</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6 col-sm-6 col-xs-12">
						<input type="text" disabled class="form-control col-md-7 col-xs-12"  name="paid_ads_end_date" id="paid_ads_end_date"  value="<?php echo $event->paid_ads_end_date; ?>">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6 col-sm-6 col-xs-12">
						<div data-toggle="buttons" class="btn-group" id="livestatus">
						  ...
						  <?php }else if($event->livestatus==1){ ?>
					...
					<div class="pull-right">
						<a href="<?php echo base_url(); ?>Ads/index/Events" class="btn btn-primary">Back to List</a>
						<?php if($event->livestatus!=2){ ?>
