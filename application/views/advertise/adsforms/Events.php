...
<div class="row">
	...
	<div class="col-md-8">
		 ...
		 <?php echo $this->session->flashdata('msg'); ?>
		  <br>
		  <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>advertise/event_addcart" id="coupon_form" enctype="multipart/form-data">	
			<br>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" class="form-control col-md-7 col-xs-12"  id="title" name="ev_title" value="<?php echo set_value('ev_title'); ?>">                     
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" class="form-control col-md-7 col-xs-12"  id="title" name="ev_location" value="<?php echo set_value('ev_location'); ?>">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<input type="hidden" id="data_cp_image" name="ev_image" value="<?php echo set_value('ev_image'); ?>" />
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-6 col-xs-12">
				<textarea  rows="3" class="mceEditor form-control col-md-7 col-xs-12" name="ev_description"><?php echo set_value('ev_description'); ?></textarea>
