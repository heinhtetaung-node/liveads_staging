...
<div class="row">
	...
	<div class="col-md-8">
		 ...
		 <?php echo $this->session->flashdata('msg'); ?>
		  <br>
		  <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url(); ?>advertise/promotion_addcart" id="coupon_form" enctype="multipart/form-data">	
			<br>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-9 col-sm-6 col-xs-12">
				<input type="text" class="form-control col-md-7 col-xs-12"  id="name" name="pro_name" value="<?php echo set_value('pro_name'); ?>">                     
			...
			<div class="form-group">
			  ...
			  <div class="col-md-9 col-sm-6 col-xs-12">
				<input type="text" class="form-control col-md-7 col-xs-12"  id="title" name="pro_price" value="<?php echo set_value('pro_price'); ?>">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-9 col-sm-6 col-xs-12">
				<input type="file"  size="20" accept="image/*"  id="cp_image"/>
				<img id="output" height="100" />
				<?php //echo form_error('pro_image');?>    </div>
				<input type="hidden" id="data_cp_image" name="pro_image" value="<?php //echo set_value('pro_image'); ?>" />
			</div>
			-->
			...
			<div class="form-group">
			  ...
			  <div class="col-md-9 col-sm-6 col-xs-12">
			<textarea  rows="3" style="height:150px" class="form-control col-md-7 col-xs-12" name="pro_description" value="<?php echo set_value('pro_description'); ?>" class="mceEditor"></textarea>
	...
	<div class="col-md-4">
		...
		<div  style='background-size:cover; background:url("<?php echo base_url(); ?>/app_liveads88/uploads/adscomponent/<?php echo $ads->previewphoto_m; ?>"); width:250px; height:440px; background-size:cover; background-repeat:no-repeat; background-position: center center;' class="previewimg">
			...
			background-color: red; position: relative; width: 112px; height: 182px; top: 201px; left: 13px;" ></div>
		</div>
	</div>
	<div class="col-md-12">
		<br><br>
