...
class User_Model extends CI_Model
{
	...
	function checkVerifi($email,$code){
	...
	*/
	...
	function apiGetSplash(){	
		$sql = "SELECT spimg_id,spimg_image_name,spimg_image_base64,spimg_website FROM splash_image WHERE spimg_status=1 ORDER BY RAND() LIMIT 1 ";
		$query = $this->db->query($sql);
		if($query->num_rows() > 0)
		{
			$row = $query->row();
